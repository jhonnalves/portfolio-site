...
export function WhatsAppButton() {
  return (
    ...
    >
      <span className="pointer-events-none hidden translate-x-2 rounded-full bg-ink-soft px-3 py-1.5 text-sm font-medium text-paper opacity-0 shadow-lg ring-1 ring-line transition-all duration-200 group-hover:translate-x-0 group-hover:opacity-100 sm:block">
        Fale comigo
      </span>
